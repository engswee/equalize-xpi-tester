...
public class JSON2XMLTest {
	...
	public void testScenario1() throws ModuleException {
		String inputFile = "TestData/JSONTransformBean/JSON2XML_Scenario1_glossary.json";
		String paramFile = "TestData/JSONTransformBean/JSON2XML_Scenario1_glossary_param.txt";
		String resultFile = "TestData/JSONTransformBean/JSON2XML_Scenario1_glossary_output.txt";
	...
	public void testScenario3() throws ModuleException {
		String inputFile = "TestData/JSONTransformBean/JSON2XML_Scenario3_array.json";
		String paramFile = "TestData/JSONTransformBean/JSON2XML_Scenario3_array_param.txt";
		String resultFile = "TestData/JSONTransformBean/JSON2XML_Scenario3_array_output.txt";
		Hashtable<String, String> contextData = ParameterHelper.newInstance(paramFile).getParams();
		String results = ResultHelper.newInstance(resultFile).getResultContent();
		ModuleTester mt = ModuleTester.newInstance("com.equalize.xpi.af.modules.FormatConversionBean", inputFile, contextData);
