...
/*	@Test
	public void testScenario1() throws IOException, MessagingException {
		String inputFile = "TestData/Base64Bean/Base64Encode_Scenario1.xml";
		String paramFile = "TestData/Base64Bean/Base64Encode_Scenario1_param.txt";
		String resultFile = "TestData/Base64Bean/Base64Encode_Scenario1_output.txt";
	...
	public void testScenario2() throws ModuleException {
		String inputFile = "TestData/Base64Bean/Base64Encode_Scenario2.txt";
		String paramFile = "TestData/Base64Bean/Base64Encode_Scenario2_param.txt";
		String resultFile = "TestData/Base64Bean/Base64Encode_Scenario2_output.txt";
		Hashtable<String, String> contextData = ParameterHelper.newInstance(paramFile).getParams();
		String results = ResultHelper.newInstance(resultFile).getResultContent();
