...
public class XML2JSONTest {
	...
	public void testScenario1() throws ModuleException {
		String inputFile = "TestData/JSONTransformBean/XML2JSON_Scenario1.txt";
		String paramFile = "TestData/JSONTransformBean/XML2JSON_Scenario1_param.txt";
		String resultFile = "TestData/JSONTransformBean/XML2JSON_Scenario1_output.txt";
	...
	public void testScenario3() throws ModuleException {
		String inputFile = "TestData/JSONTransformBean/XML2JSON_Scenario3.txt";
		String paramFile = "TestData/JSONTransformBean/XML2JSON_Scenario3_param.txt";
		String resultFile = "TestData/JSONTransformBean/XML2JSON_Scenario3_output.txt";
		Hashtable<String, String> contextData = ParameterHelper.newInstance(paramFile).getParams();
		String results = ResultHelper.newInstance(resultFile).getResultContent();
		ModuleTester mt = ModuleTester.newInstance("com.equalize.xpi.af.modules.FormatConversionBean", inputFile, contextData);
