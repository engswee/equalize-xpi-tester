...
public class XML2DeepPlainTest {
	...
	public void testScenario1a() throws ModuleException {
		String inputFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1.xml";
		String paramFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1a_param.txt";
		String resultFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1a_output.txt";
	...
	public void testScenario1b() throws ModuleException {
		String inputFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1.xml";
		String paramFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1b_param.txt";
		String resultFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario1b_output.txt";
		Hashtable<String, String> contextData = ParameterHelper.newInstance(paramFile).getParams();
		String results = ResultHelper.newInstance(resultFile).getResultContent();
		ModuleTester mt = ModuleTester.newInstance("com.equalize.xpi.af.modules.FormatConversionBean", inputFile, contextData);
	...
	public void testScenario3() throws ModuleException {
		String inputFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario3.xml";
		String paramFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario3_param.txt";
		String resultFile = "TestData/DeepFCCBean/XML2DeepPlain_Scenario3_output.txt";
		Hashtable<String, String> contextData = ParameterHelper.newInstance(paramFile).getParams();
		String results = ResultHelper.newInstance(resultFile).getResultContent();
		ModuleTester mt = ModuleTester.newInstance("com.equalize.xpi.af.modules.FormatConversionBean", inputFile, contextData);
